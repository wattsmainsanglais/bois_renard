    ...
    return (
        <div id="giteImages" className={`grid grid-cols-2 grid-rows-6 lg:grid-cols-6 lg:grid-rows-2  lg:${flow}`}>
            ...
            <Dialog key={index}>
                ...
                <div id="modal"  className={` ${show? "flex" : "hidden"} fixed left-[50%] top-[50%] z-50 w-[90%] lg:w-1/2 h-9/10 translate-x-[-50%] translate-y-[-50%] border bg-white p-5 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] flex-col lg:flex-row rounded-lg justify-center lg:justify-between items-center`}>
